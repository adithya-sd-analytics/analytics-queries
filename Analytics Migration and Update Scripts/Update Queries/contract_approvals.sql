...
report_tab as (
  ...
  left join `spotdraft-prod.prod_india_db.public_contracts_v3_contractrequiredapprovalv2` as d 
  on a.required_approval_id = d.id
  left join `spotdraft-prod.prod_india_db.public_contracts_v3_contractrequiredfullapproval` as e  
  ...
  left join `spotdraft-prod.prod_india_db.public_sd_organizations_organizationuser` as g 
  on f.requestor_id = g.id
  left join `spotdraft-prod.prod_india_db.public_sd_organizations_organizationuser` as h 
...
--     end as pending
--        from `spotdraft-prod.prod_india_db.public_contracts_v3_signrecipient` as a
...
--       join `spotdraft-prod.prod_india_db.public_sd_organizations_organizationuser` as d on b.created_by_id = d.user_id
--       join `spotdraft-prod.prod_india_db.public_sd_organizations_organizationuser` as e on a.org_user_id = e.id
--       join `spotdraft-prod.prod_india_db.public_sd_organizations_companyprofile` as f on f.owner_id = e.organization_id
