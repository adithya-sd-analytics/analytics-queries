...
from `spotdraft-prod.prod_india_db.public_contracts_v3_contractkeypointer` as a
join `spotdraft-prod.prod_india_db.public_historic_contracts_keypointer` as b on a.key_pointer_id = b.id
